...
function openPanel(event) {
  ...
  //mainImage.style.width = "50vh"; // Set the new width
...
function parseSpecs(specs) {
  ...
  specsArray.forEach((value, index) => {
    const key = index === 0 ? "Specification 1" : index === 1 ? "Specification 2" : index === 2 ? "Specification 3" : index === 3 ? "Specification 4" : index === 4 ? "Specification 5" : "Specification 6";
